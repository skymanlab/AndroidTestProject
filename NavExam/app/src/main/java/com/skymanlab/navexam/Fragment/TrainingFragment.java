...
import com.skymanlab.navexam.R;
...
public class TrainingFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button program = (Button) view.findViewById(R.id.F_training_Btn_program);
        program.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Navigation.findNavController(v).navigate(R.id.action_navGraphMoreInfoFragment_to_navigationProgram);
            }
        });
